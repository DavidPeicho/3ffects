...
ShaderChunk.lights_fragment_extended_diffusion_begin = /* glsl */`
...
IncidentLight directLight;
    ...
    for ( int i = 0; i < NUM_DIR_LIGHTS; i ++ ) {
        ...
        getDirectionalLightInfo( directionalLight, geometry, directLight );
            ...
            directLight.color *= getShadowAttenuation(shadowDistanceTmp, shadowCoordsTmp);

        #endif // USE_SHADOWMAP && (UNROLLED_LOOP_INDEX < NUM_DIR_LIGHT_SHADOWS)

        RE_Direct(directLight, geometry, material, reflectedLight);
        #ifdef RE_Direct_Extended
            RE_Direct_Extended(directLight, shadowTmp, geometry, material, reflectedLight);
